...
const SignUp = () => {
    ...
    return (
        <>
            ...
            <Auth>
                <div className="bg-white border flex flex-col gap-2 p-4">
                <img draggable="false" className="mx-auto h-14 w-20 object-contain" src={logo} />
                    <form
                    ...
                    >
                        ...
                        <span className="my-1 text-gray-500">OR</span>
